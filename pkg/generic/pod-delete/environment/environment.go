...
func GetENV(experimentDetails *experimentTypes.ExperimentDetails) {
	...
	experimentDetails.ChaosNamespace = common.Getenv("CHAOS_NAMESPACE", "shubham")
	...
	experimentDetails.AppNS = common.Getenv("APP_NAMESPACE", "shubham")
	experimentDetails.AppLabel = common.Getenv("APP_LABEL", "run=nginx")
	experimentDetails.AppKind = common.Getenv("APP_KIND", "deployment")
